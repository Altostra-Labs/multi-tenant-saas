...
class UserManagement:
    def create_user_pool(self, tenant_id, application_site_url):
    ...
    def create_user_pool_client(self, user_pool_id, user_pool_callback_url):
    ...
    def create_user_tenant_mapping(self, user_name, tenant_id, table_tenant_user_map):
